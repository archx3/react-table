...
function TableRow(_ref) {
  ...
  return React.createElement(TableBodyRow, {
    ...
    return React.createElement(TableBodyData, {
      ...
      style: style,
      onClick: handleClick
    }, formatDate(item[key]) || formatCountry(item[key], key) || render && render(item) || item[key] || '-');
  }), renderIcon(item));
}
...
function Table(props) {
  ...
  }, React.createElement("tr", null, React.createElement("td", null, emptyMessage))) : React.createElement(TableBody$1, {
    count: count,
    data: data,
    dataIndexes: indexes,
    hover: hover,
